...
type ParseStats struct {
	// Skipped counts skipped records by reason; nil means none.
	Skipped map[SkipReason]int
}

// Skip records one skipped record, allocating the map on first use.
func (s *ParseStats) Skip(reason SkipReason) {
	if s.Skipped == nil {
...
// TotalSkipped is the number of records skipped across all reasons.
func (s ParseStats) TotalSkipped() int {
	total := 0
